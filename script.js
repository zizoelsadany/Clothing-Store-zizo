...
init();
animate();
// دالة التحويل لصفحة الدفع
function goCheckout() {
  window.location.href = "chek.html";
}

// ربط كل أزرار الـ Buy بالوظيفة
document.querySelectorAll(".product-item .product-actions button:first-child")
  .forEach(button => {
    button.addEventListener("click", goCheckout);
  });
